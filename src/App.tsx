...
function App() {
  ...
  const ctx: CanvasRenderingContext2D = canvas.getContext('2d')!; // get the 2D rendering context of the canvas
  ...
  canvas.addEventListener('mousemove', (event: MouseEvent) => {
    ...
    if (mousePositionContainer !== null) {
      mousePositionContainer.innerHTML = `Mouse Position - X: ${mouseX}, Y: ${mouseY}`;
    }
  });
